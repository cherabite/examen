   ...
   $(document).ready(function () {
	   ...
	   $("#ajax_loader").hide(); 
	   jQuery("#form_matr").validationEngine({ 'custom_error_messages': {
				 '#annexe': {
                'required': {
                    'message': "أدخل رمز الولاية التي سجلت فيها"
                }
               },
			 '#anneeins': {
                'required': {
                    'message': "أدخل السنة التي سجلت فيها "
				}
                },
				'#nseq': {
                'required': {
                    'message': "أدخل الرقم التسلسلي "
				}
                }
        ...
        var valid = $("#form_matr").validationEngine('validate');
        if (valid == true) {  
        	var form=  $("#form_matr");
			 $("#ajax_loader").show();
                        $.ajax({
                            type: 'POST',
                            url: base_url+'index.php/wel/form_matr',
                            dataType: 'json',
                            data: form.serialize(),
							cache:false,
