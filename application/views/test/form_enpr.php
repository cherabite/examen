      ...
      <div id="info_enpr"> 
				...
				<h2> المــركــز الــولائــي : <?php echo $cwefd->WILAYA_CWEFD; ?></h2>
				<div id="errorvalidation"> 
		     	</div>
		          <form id="form_enpr"   class="form-horizontal"   >	
           
                    <div class="form-group row">
							 <div class="form-group row">
                                <label class="col-md-4 "  style="color:blue">رقـــم  الإســتمـارة :</label>
                                <div class="col-md-8 form-inline">
							
                                    <input class="validate[required,minSize[1],maxSize[5],custom[onlyNumberSp]] text-input inputblock form-control"  style="width:70px" name="enpr" id ="enpr" value="" type="text"  size="5" maxlength="5" autocomplete="off" onkeypress="return vnum(this, event, ' ')" > 
                                     <select class="form-control" id ="annexe"  name="annexe" readonly="true">
                                        <option value="<?php echo $cwefd->CODE_CWEFD; ?>"><?php echo $cwefd->CODE_CWEFD; ?></option>
                                    </select>
									 <label for="" class="col-form-label"><?php echo $cwefd->WILAYA_CWEFD; ?></label>
                                </div>
							</div>
	...
	<script type="text/javascript" src="<?php echo base_url() ?>custom/enpr.js"  charset="utf-8"></script>  			 