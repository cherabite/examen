			...
			<?php if(isset($valid_error) and $valid_error != null ) 
               echo  '<div class="alert alert-warning alert-dismissible" role="alert" <span style="color: #FF0000; font-weight: bold">إنــتـبـــه </span>
				...
				?>
	 	        	...
	 	        	<form   class="form-horizontal" id="feuille_examen" method="post" action="<?php echo base_url('index.php/imp_rapport/feuille_examen') ?>"  target="_blank"  > 
								...
								<div class="row">
								 <div class="col-md-8"></div>
									   <div class="col-md-2">
												 ...
												 <p>   <span class="glyphicon glyphicon-print "></span> &nbsp;طباعة التصحيح الأول </p></button> 
									   </div> 
                                        <div class="col-md-2">
												  <button type="submit" name="valid_2" id="valid_2"  value="valid_2" class="btn btn-primary ">
												 <p>   <span class="glyphicon glyphicon-print "></span> &nbsp;طباعة التصحيح الثاني </p></button> 
									   </div>									   
                               </div>							   
